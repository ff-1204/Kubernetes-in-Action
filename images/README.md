...
이 폴더의 모든 이미지는 **쿠버네티스 공식 문서(kubernetes.io)** 에서 가져왔습니다.

- 저작권: © The Kubernetes Authors
- 라이선스: [Creative Commons Attribution 4.0 International (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/)
- 원본 문서 라이선스 고지: <https://github.com/kubernetes/website/blob/main/LICENSE>

CC BY 4.0에 따라 출처를 밝히면 자유롭게 사용·수정·재배포할 수 있습니다. 각 이미지를 사용하는 노트에도 캡션으로 출처를 표기했습니다.
